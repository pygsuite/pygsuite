...
class ItemType(Enum):
    ...
    @classmethod
    def _missing_(cls, value):
        from pygsuite.forms.page_break_item import PageBreakItem
        from pygsuite.forms.question_item import QuestionItem
        from pygsuite.forms.question_group_item import QuestionGroupItem
        from pygsuite.forms.text_item import TextItem
        from pygsuite.forms.video_item import VideoItem
        from pygsuite.forms.image_item import ImageItem
